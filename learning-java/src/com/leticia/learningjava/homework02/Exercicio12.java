...
public class Exercicio12 {
	...
	public static void main(String[] args) {
		 ...
		 * descontos são os Imposto de Renda, que depende do salário bruto e 3% para o
		 ...
		 * da sua hora e quantidade de horas trabalhadas no mês. Desconto do IR:
		 * 
		 * - Salário Bruto até 900 (inclusive) - isento. - Salário Bruto até 1500
		 * (inclusive) - desconto de 5%. - Salário Bruto até 2500 (inclusive) - desconto
		 * de 10%. - Salário Bruto acima de 2500 (inclusive) - desconto de 20%.
		 * 
		 */
		...
		System.out.println("Sálario Bruto: (" + valorHora + " * " + quantidadeHorasTrabalhadas + ")  : " + " " + "R$ "
				+ salarioBruto);
